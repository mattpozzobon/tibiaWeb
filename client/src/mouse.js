...
Mouse.prototype.__handleMouseClick = function() {
  ...
  if(!gameClient.player.isMoving() && this.__mouseDownObject.which.constructor.name === "Tile" && !gameClient.keyboard.isControlDown() && !this.__rightButtonPressed) {
...
Mouse.prototype.__handleMouseDown = function(event) {
  ...
  if(!gameClient.keyboard.isShiftDown() && !gameClient.keyboard.isControlDown() && event.buttons === 1) {
