...
import { BitFlag, TileFlag } from "./Cbitflag";
import ThingEmitter from "./Cthing-emitter";
...
class Thing extends ThingEmitter implements IThing{
  ...
  isDoor(): boolean {
    return this instanceof (require('./Cdoor').default);
  }

  isItem(): boolean {
    return this instanceof (require('./Citem').default);
  }
