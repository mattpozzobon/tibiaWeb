import { CreatureForgetPacket, CreatureMovePacket, CreatureTeleportPacket, EffectMagicPacket, PlayerLoginPacket } from "../network/protocol";
import { FriendStatusPacket } from "../creature/player/friendlist";
