import SpeechHandler from "../chat/speech-handler";
import { ConditionManager } from "../handler/condition/condition-manager";
import { CreatureProperties } from "./creature-properties";
