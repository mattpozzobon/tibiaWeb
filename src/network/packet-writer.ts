...
export class PacketWriter extends Packet {
  ...
  writeBeltPotionQuantities(equipment: any): void {
     ...
     * Uses UInt16 for quantities to support values > 255
     */
